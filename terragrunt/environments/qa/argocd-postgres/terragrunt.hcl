...
#  source = "git@github.com:4sh/4sh-terraform-libs.git//shared/modules/argocd-postgres"
  source = "../../../../terraform-libs/argocd-postgres"
}
...
inputs = {
  ...
  postgres_helm_chart_version = local.environment_vars.locals.postgres_helm_chart_version
  postgres_database = local.environment_vars.locals.postgres_database
  postgres_username = local.environment_vars.locals.postgres_username
